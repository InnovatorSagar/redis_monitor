    ...
    return (
      <div className="app-container">
        ...
        <div className="upper-cards">
          <MatrixCardComponent heading="Memory Matrix" notify={this.state.memoryFlag} />
          <MatrixCardComponent heading="Number Of Clients Matrix" notify={this.state.numberOfClientsFlag}/>
        </div>
        <div className="upper-cards">
          <MatrixCardComponent heading="Performance Matrix" notify={this.state.performanceFlag}/>
          <MatrixCardComponent heading="Hit-Ratio Matrix" notify={this.state.hitRatioFlag}/>
        </div>
      </div>
    );
  }
